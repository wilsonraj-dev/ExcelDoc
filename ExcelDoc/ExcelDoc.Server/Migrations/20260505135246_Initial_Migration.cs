        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FK_IdEmpresa = table.Column<int>(type: "int", nullable: false),
                    FK_IdDocumento = table.Column<int>(type: "int", nullable: false),
                    FK_IdPerfilMapeamento = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Processamento_PerfilMapeamento_FK_IdPerfilMapeamento",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Processamento_FK_IdPerfilMapeamento",
                table: "Processamento",
                column: "FK_IdPerfilMapeamento");
